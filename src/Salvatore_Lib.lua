...
local Button_Icon = "97046718518328" 
...
local Themes = {
	...
	Dark = {
		Name = "Dark",
		Accent = Color3.fromRGB(161, 161, 161),
	...
	return function(Config)
		...
		TitleBar.CloseButton = BarButton(Components.Assets.Close, UDim2.new(1, -4, 0, 4), TitleBar.Frame, function()
			Library.Window:Dialog({
				Title = "Close",
				Content = "Are you sure you want to close Salvatore?",
				Buttons = {
					{
						Title = "Yes",
						Callback = function()
		...
		function Window:Minimize()
			...
			if not MinimizeNotif then
				...
				if not Mobile then Library:Notify({
					Title = "Salvatore",
					Content = "Press " .. Key .. " to toggle salvatore.",
					Duration = 6
					})
				else 
					Library:Notify({
						Title = "Salvatore",
						Content = "Tap to the salvatore logo to toggle salvatore.",
						Duration = 6
					})
				end
			end
...
local MinimizeButton = New("TextButton", {
	...
	New("ImageLabel", {
		Image = "rbxassetid://97046718518328",
		Size = UDim2.new(1, 0, 1, 0),
		BackgroundTransparency = 1,
